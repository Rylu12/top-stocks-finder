...
The table of data below was collected by webscraping http://www.TipRanks.com
### Features:
...
st.write('### Stocks Price Target from TipRanks.com (Updated: 2020-09-16)\n(Best used in full-screen mode by clicking top-right of table. "PT" stands for "Price Target")')
...
st.info("This web app is created by Ryan L. Email questions or concerns to ry1291@gmail.com, thanks!", )
